...
describe('Wallet', () => {
        ...
        beforeEach(() => {
            ...
            describe('and doing the same transaction', () => {
                ...
                it('clones the `sendAmount` output for the recipient', () => {
                    expect(transaction.ouput.filter(output => output.address === recipient).map(output => output.amount)).toEqual([sendAmount]);
                })
            })
        })
    })
    ...
    describe('calculating a balance', () => {
        ...
        it('calculate the balance for blochchain transactions matching the sender', () => {
            expect(wallet.calculateBalance(bc)).toEqual(INITIAL_BALANCE - (addBalance * repeatAdd));
        })
